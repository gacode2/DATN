...
<body style="background-color: rgba(35,45,57,0.8);">
    ...
    <div class="wrapper fadeInDown">
        <div id="formContent">
            <!-- Login Form -->
            <form style="padding-top: 50px" method="POST" action="{{ route('login') }}">
                @csrf
                ...
                <input style="margin-top: 15px" type="password" id="password" class="fadeIn third" name="password" placeholder="password">
                @error('password')
                <span style="display: block" class="text-danger">
                    <strong>{{ $message }}</strong>
                </span>
